...
def args_parser():
    ...
    parser.add_argument('--hook', type=bool, default=0, help='if use hook or not')
    # other arguments
    parser.add_argument('--dataset', type=str, default='cifar10', help="name of dataset")
    parser.add_argument('--iid',  type=bool,default=0, help='whether i.i.d or not')
    ...
    # attack
    parser.add_argument('--attacker_rate', type=float, default=0.2, help=' ')
    parser.add_argument('--attack', type=bool, default=1, help=' ')
    parser.add_argument('--attack_type', type=str, default='gaussian', help='gaussian,backdoor,label_attack')
    parser.add_argument('--malicious_behavior_rate', type=float, default=1, help='h')
    #defense
    parser.add_argument('--rule', type=str, default='ours', help='h')
    parser.add_argument('--edge', type=bool, default=0, help='h')
